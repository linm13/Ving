 ...
 */
public class overhead_line {
    public static HashMap<String,HashMap<String, String>> overhead_lineMap = new HashMap<String,HashMap<String, String>>();
    public static HashMap<String,HashMap<String, String>> overhead_lineResultMap = new HashMap<String,HashMap<String, String>>();
    public static void addMap(String name, String phases, String from,String to,String length,String configuration) {
        ...
        overhead_lineMap.put(name,tempMap);
    }
    public static void addResultMap(String name, String phases, String from,String to,String length,String configuration,String power_in,String power_out,String power_losses) {
        ...
        overhead_lineResultMap.put(name,tempMap);
    }
}
